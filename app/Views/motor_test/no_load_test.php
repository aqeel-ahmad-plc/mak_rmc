...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4 pt-2">
      <h1 class="h3 mb-0 text-gray-800"><b>No Load Test</b></h1>
  </div>
  <form action="<?php echo base_url()."/motor_test/no_load_test";?>" method="post">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"> <input type="text" name="rpm_no_load" id="rpm_no_load"> </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><input type="text" name="motor_size_no_load" id="motor_size_no_load"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
      ...
      <div class="col-xl-2 col-md-2">
        <input type="submit" value="Record No Load Point" class="btn btn-primary"/>
      </div>
