...
class Motor_Test extends BaseController
{
	...
	public function edit_rated_data($test_id){
		$data = [];
    $rated_data_model  = new Motor_Test_model();
		$data['rated_data'] = $rated_data_model->getMotorTestData($test_id);
        ...
        'motor_sno' => 'required',
          ...
          'motor_sno' => $this->request->getVar('motor_sno'),
				...
				$model->updateMotorRatedData($test_id, $newData);
				$session = session();
				$session->setFlashdata('success', 'Test data updated successfully');
				return redirect()->to(base_url().'/motor_test/manage');
			}
		}
        ...
        echo view('templates/header', $data);
        echo view('templates/sidebar');
				echo view('motor_test/edit_rated_data');
				echo view('templates/footer');
	}
